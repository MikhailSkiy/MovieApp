...
import com.mikhailskiy.www.wovies.adapters.CastListRecyclerViewAdapter;
...
import com.mikhailskiy.www.wovies.interfaces.ExploreMoreBtnListener;
...
import com.mikhailskiy.www.wovies.ui.CustomDividerItemDecoration;
...
public class CastListFragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        Timber.i("Setting screen name: " + "Cast list");
        mTracker.setScreenName("Screen name" + "Cast list fragment");
