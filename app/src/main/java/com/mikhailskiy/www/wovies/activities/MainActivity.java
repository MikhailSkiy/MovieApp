...
import com.mikhailskiy.www.wovies.events.AuthCompletedEvent;
...
import com.mikhailskiy.www.wovies.helpers.GenresMap;
...
//        }
    ...
    protected void onResume() {
        ...
        Timber.i("Setting screen name: " + "Movies");
        mTracker.setScreenName("Movies");
...
//    }
    ...
    private void switchToLogout() {
        ...
        mainNavigationMenu_.getMenu().getItem(0).setTitle(mainNavigationMenu_.getMenu().getItem(0).getTitle());
    }
...
//                    break;
                ...
                case R.id.rate_app_menu_btn:
                    ...
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.mikhailskiy.www.wovies"));
